      ...
      mutation.addedNodes.forEach(function (node) {
        if (node.nodeType === 1) {
          if (node.matches && node.matches(OBSERVE_SELECTOR)) {
            ...
            const newAnimatables = node.querySelectorAll(OBSERVE_SELECTOR);
            if (newAnimatables.length) {
              applyScrollAnimations();
            }
          }
        }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Tzachi Photographer משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '52496556-6c1b-4bc1-afba-b67f72d39ed9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '52496556-6c1b-4bc1-afba-b67f72d39ed9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '52496556-6c1b-4bc1-afba-b67f72d39ed9';
